...
// Mobile layout: chat and trace are full-screen panes toggled by a bottom tab bar. Hidden on desktop.
export function MobileTabs({ chat, trace, isStreaming, hasTrace }: Props) {
